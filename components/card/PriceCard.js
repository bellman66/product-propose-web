        ...
        <>
            <div className="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    ...
                    <div className="ml-6">
                        <h3 className="mb-1 leading-5 text-gray-800 dark:text-gray-100 font-bold text-2xl">12%</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    ...
                    <div className="ml-6">
                        <h3 className="mb-1 leading-5 text-gray-800 dark:text-gray-100 font-bold text-2xl">3245</h3>
                        <p className="text-gray-600 dark:text-gray-400 text-sm tracking-normal font-normal leading-5">Subscribers</p>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    ...
                    <div className="ml-6">
                        <h3 className="mb-1 leading-5 text-gray-800 dark:text-gray-100 font-bold text-2xl">$1245</h3>
